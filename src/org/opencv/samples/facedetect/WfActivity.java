...
public class WfActivity extends Activity implements CvCameraViewListener2, OnTouchListener  {
            ...
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    try {
                        ...
                        mCascadeFile = new File(cascadeDir, "wf_cascade.xml");
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        //	Point wfc = new Point(flyrect.x + flyrect.width/2, flyrect.y + flyrect.height/2);
    	//int rad = (int) Math.round((flyrect.width + flyrect.height) * 0.25);
       	//circle(mRgba, wfc, rad, new Scalar(255, 0, 0), 2, 8, 0);

        wflycount = format("Count : %d", (int)facesArray.length);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_DOWN:
        	Toast.makeText(WfActivity.this, wflycount, Toast.LENGTH_SHORT).show();
        //  toggle();
            // Intent cameraIntent = new Intent( android.provider.MediaStore.ACTION_IMAGE_CAPTURE ); 
            // startActivityForResult(cameraIntent, 1337);
           // int bufferSize = 300 * 300 * 3;
